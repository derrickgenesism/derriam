...
export default function WouldYouRatherPage() {
  ...
  useEffect(() => {
    async function fetchData() {
      const pRes = await supabase.from("prompts").select("*").eq("category", "would-you-rather").eq('is_active', true).order('created_at', { ascending: true }).order('question', { ascending: true });
